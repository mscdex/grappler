...
function isAllowed(setting, origin) {
	var parts = url.parse(origin);
	return setting.indexOf('*:*') != -1	||
		   setting.indexOf(parts.host + ':' + parts.port) != -1 ||
		   setting.indexOf(parts.host + ':*') != -1 ||
		   setting.indexOf('*:' + parts.port) != -1;
}
